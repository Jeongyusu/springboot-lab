...
public class HttpMethodController {
    ...
    @GetMapping("/req/get")
    public void methodGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
    ...
    public String methodPost(HttpServletRequest request, HttpServletResponse response) {
        System.out.println("name : " + request.getParameter("name"));
        System.out.println("name : " + request.getParameter("price"));
        System.out.println("name : " + request.getParameter("qty"));
